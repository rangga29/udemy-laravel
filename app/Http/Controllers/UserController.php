...
class UserController extends Controller
{
    public function login(Request $request)
    {
        ...
        if (auth()->attempt(['username' => $incomingFields['loginusername'], 'password' => $incomingFields['loginpassword']])) {
            ...
            return redirect('/')->with('success', 'You Successfully Login');
        } else {
    ...
    public function register(Request $request)
    {
        ...
        auth()->login($user);
        return redirect('/')->with('success', 'Thankyou for register');
    }
    ...
    public function storeAvatar(Request $request)
    {
        ...
        if ($oldAvatar != "/storage/avatars/fallback-avatar.jpg") {
        ...
        return back()->with('success', 'Successfully Changed Avatar');
    }
